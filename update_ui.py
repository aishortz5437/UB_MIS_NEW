...
with open('src/pages/WorkDetail.tsx', 'r') as f:
    content = f.read()

start_marker = "{/* 4. Financial Progress Section */}"
end_marker = "</PageTransition>"

start_idx = content.find(start_marker)
end_idx = content.find(end_marker, start_idx)

if start_idx != -1 and end_idx != -1:
    new_content = """          {/* 4. Financial Progress Section */}
...
"""
    ...
    modified = content[:start_idx] + new_content + content[end_idx-8:]
    with open('src/pages/WorkDetail.tsx', 'w') as f:
        f.write(modified)
