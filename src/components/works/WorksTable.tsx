      ...
      <Table>
        ...
        <TableBody>
          {works.map((work, index) => {
            const displayClientName = (work.client_name || '').trim();
            const sanitizedClientName = displayClientName.toLowerCase() === 'executive engineer' ? '' : displayClientName;
              ...
              >
                ...
                <TableCell className="max-w-[220px]">
                  <div className="flex flex-col gap-1 items-start">
                    <span
                      className="text-sm text-muted-foreground font-medium whitespace-nowrap overflow-hidden text-ellipsis"
                      title={sanitizedClientName || ''}
                    >
                      {sanitizedClientName || '-'}
                    </span>
